...
if [[ "$unittest" = true ]]; then
    ...
    echo "  --n_reps NUM REPS        number of times that a test should be repeated for a given netem delay"
    echo "  --tag TAG                unique tag for this run (i.e. output written to outputs/foo_{TAG}/...)"
    echo ""
